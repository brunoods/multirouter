...
def load_inventory():
    ...
    try:
        ...
        messagebox.showerror("Erro de Inventário", f"O ficheiro {DEVICES_FILE} está corrompido.")
        return []
...
def save_inventory(devices):
    ...
    try:
        ...
        messagebox.showerror("Erro ao Salvar", f"Não foi possível salvar o inventário: {e}")
