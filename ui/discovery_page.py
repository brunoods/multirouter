...
class DiscoveryPage(ttk.Frame):
    def __init__(self, parent, controller):
        ...
        ttk.Label(params_frame, text="Gama de Rede (CIDR):").grid(
        ...
        ttk.Label(params_frame, text="Utilizador Comum:").grid(
        ...
        ttk.Label(params_frame, text="Senha Comum:").grid(
        ...
        self.run_button = ttk.Button(
            action_frame,
            text="Iniciar Descoberta",
            style="primary",
            command=lambda: start_discovery(self.controller),
        )
