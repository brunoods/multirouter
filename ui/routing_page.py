...
class RoutingPage(ttk.Frame):
    def __init__(self, parent, controller):
        ...
        ttk.Label(config_frame, text="Próximo Salto:").grid(
        ...
        ttk.Button(
            ...
            text="Adicionar Rota",
            style="primary",
            command=lambda: add_static_route(self.controller),
